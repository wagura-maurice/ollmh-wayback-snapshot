...
#accessibility .button {display: block;width:14px;height:14px;float: left;background: url(/web.archive.org/web/20220319205345im_/http:/ourladyoflourdesmweahospital.org/libraries/expose/interface/images/typography.png);margin: 2px;}
...
.tip-title {padding: 0;margin: 0;font-size: 100%;font-weight: bold;margin-top: -15px;padding-top: 15px;padding-bottom: 5px;background: url(/web.archive.org/web/20220319205345im_/http:/ourladyoflourdesmweahospital.org/templates/system/images/selector-arrow.png) no-repeat;}
...
/* System Messages */
/* OpenID icon style */
input.system-openid, input.com-system-openid { background: url(https://web.archive.org/web/20220128210253im_/http://openid.net/images/login-bg.gif) no-repeat;background-color: #fff;background-position: 0 50%;color: #000;padding-left: 18px;}
...
/*
     ...
     INTERNET ARCHIVE ON 21:55:14 Aug 05, 2026.
...
playback timings (ms):
  ...
  load_resource: 151.286
  PetaboxLoader3.resolve: 93.458
  PetaboxLoader3.datanode: 24.411
*/